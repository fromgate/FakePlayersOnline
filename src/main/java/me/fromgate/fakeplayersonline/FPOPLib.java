...
public class FPOPLib {
    ...
    public static void sendFakePlayerPackets(Player player, Collection<FakePlayer> playerList, boolean show) {
        ...
        for (FakePlayer pStr : playerList) {
            ...
            if (property != null) {
                ...
                /* FakePlayersOnline.getPlugin().u.log(wgp.getName());
                FakePlayersOnline.getPlugin().u.log("name: " + property.getName());
                FakePlayersOnline.getPlugin().u.log("value: " + property.getValue());
                FakePlayersOnline.getPlugin().u.log("signature: "+ property.getSignature()); */
            }
    ...
    public static void initPacketListener() {
        ProtocolLibrary.getProtocolManager().addPacketListener(
                new PacketAdapter(FakePlayersOnline.instance, PacketType.Status.Server.SERVER_INFO) {
                    @Override
