...
public class FPOcbo {
    ...
    private static String [] tested_versions = {"v1_7_R1"};
    ...
    public static void init(){
        try{
            ...
            Packet201PlayerInfo = nmsClass("PacketPlayOutPlayerInfo");
            ...
            if (!isTestedVersion()) {
                FakePlayersOnline.instance.u.log("[FakePlayersOnline] +--------------------------------------------------------------------------+");
                FakePlayersOnline.instance.u.log("[FakePlayersOnline] + This version of FakePlayersOnline was not tested with CraftBukkit "+FPOcbo.getMinecraftVersion().replace('_', '.')+" +");
                FakePlayersOnline.instance.u.log("[FakePlayersOnline] + Check updates at http://dev.bukkit.org/server-mods/fakeplayers/          +");
                FakePlayersOnline.instance.u.log("[FakePlayersOnline] + or use this version at your own risk                                     +");
                FakePlayersOnline.instance.u.log("[FakePlayersOnline] +--------------------------------------------------------------------------+");
            }
            ...
            FakePlayersOnline.instance.u.log("[FakePlayersOnline] +------------------------------------------------------------------------");
            FakePlayersOnline.instance.u.log("[FakePlayersOnline] + WARNING!!! THIS PLUGIN IS NOT COMPATIBLE WITH CRAFTBUKKIT "+getMinecraftVersion().replace('_', '.')+"    +");
            FakePlayersOnline.instance.u.log("[FakePlayersOnline] + FakePlayersOnline will not work correctly. Please check updates at:    ");
            FakePlayersOnline.instance.u.log("[FakePlayersOnline] + http://dev.bukkit.org/server-mods/fakeplayers/                         ");
            FakePlayersOnline.instance.u.log("[FakePlayersOnline] +------------------------------------------------------------------------");
        }
    }
